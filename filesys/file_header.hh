...
public:
    ...
    /// Expand file
    bool Expand(Bitmap *bitMap, unsigned newBytes);
...
private:
    RawFileHeader raw;
    int firstIndir[NUM_INDIRECT];  ///< Sectors for the first indirection
                                   ///< table.
    int secondIndir[NUM_INDIRECT][NUM_INDIRECT];  ///< Sectors for the second
                                                  ///< indirection table.
};
